        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!isEmailMatched && !isNumberMatched) {
                ...
                if (isEmailMatched.id === isNumberMatched.id) {
                    ...
                    yield this.contactRepository.updateLinkedId(isEmailMatched.id, isNumberMatched.id);
                    yield this.contactRepository.updateLinkPrecedence(isNumberMatched.id);
                    const response = yield this.sendResponse(isEmailMatched.id);
                    return response;
                }
            }
            else {
                const linkedId = (isEmailMatched === null || isEmailMatched === void 0 ? void 0 : isEmailMatched.id) || (isNumberMatched === null || isNumberMatched === void 0 ? void 0 : isNumberMatched.id);
